			...
			<div class="l-box-lrg pure-u-2 pure-u-md-2-5">
				<form class="pure-form pure-form-stacked" method="POST">
					<fieldset>
						...
						<input name="segunda" type="time" class="pure-input-rounded" value=<?php echo $res[0]->segunda?>  <?php echo isset($_POST['segunda']) ? "value='".$_POST['segunda']."'":""; ?> required >
						<input name="segunda2" type="time" class="pure-input-rounded"  <?php echo isset($_POST['segunda2']) ? "value='".$_POST['segunda2']."'":""; ?> required >

						<label for="terca" style="margin-top: 20px" >terça-feira:</label>
						<input name="terca" type="time" class="pure-input-rounded" value=<?php echo $res[0]->terca?>    <?php echo isset($_POST['terca']) ? "value='".$_POST['terca']."'":""; ?> required >
						...
						<input name="quarta" type="time" class="pure-input-rounded" value=<?php echo $res[0]->quarta?>  <?php echo isset($_POST['quarta']) ? "value='".$_POST['quarta']."'":""; ?> required >
						...
						<input name="quinta" type="time" class="pure-input-rounded" value=<?php echo $res[0]->quinta?>  <?php echo isset($_POST['quinta']) ? "value='".$_POST['quinta']."'":""; ?> required >
						...
						<input name="sexta" type="time" class="pure-input-rounded" value=<?php echo $res[0]->sexta?> 	<?php echo isset($_POST['sexta']) ? "value='".$_POST['sexta']."'":""; ?> required >
						...
						<input name="sabado" type="time" class="pure-input-rounded" value=<?php echo $res[0]->sabado?>  <?php echo isset($_POST['sabado']) ? "value='".$_POST['sabado']."'":""; ?> required >
						...
						<input name="domingo" type="time" class="pure-input-rounded" value=<?php echo $res[0]->domingo?>  <?php echo isset($_POST['domingo']) ? "value='".$_POST['domingo']."'":""; ?> required >
						...
						<input name="feriados" type="text" class="pure-input-rounded" value=<?php echo $res[0]->feriados?>   <?php echo isset($_POST['feriados']) ? "value='".$_POST['feriados']."'":""; ?> required >
						</fieldset>
